...
### Ollama Setup
- **[Running Ollama Locally and Accessing It from Google Colab via Pinggy](https://youtu.be/8WKUWnpyxBQ)** - CodeVision tutorial showing how to set up Ollama on your laptop and expose it via Pinggy tunnel for use in Colab notebooks
